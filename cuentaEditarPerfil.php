...
$du = mysqli_fetch_object($u->getOne($usuario_id));
if (!empty($_POST)) {
    ...
    if($update){
        ...
        header("Location: cuenta.php?mensaje=" . urlencode("Usuario actualizado correctamente"));
    }else{
...
<body>
        ...
        <div class="container p-5" style="background-color: whitesmoke; max-width: 800px;">
            <form method="post" action="cuentaEditarPerfil.php" enctype="multipart/form-data">
